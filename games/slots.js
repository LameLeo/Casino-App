...
const spinSound = new Audio("/Ace-Arcade/sounds/spin.wav");
const winSound = new Audio("/Ace-Arcade/sounds/win.wav");
const loseSound = new Audio("/Ace-Arcade/sounds/lose.wav");
const jackpotSound = new Audio("/Ace-Arcade/sounds/jackpot.wav");
